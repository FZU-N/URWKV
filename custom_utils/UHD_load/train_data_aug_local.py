...
class TrainData(data.Dataset):
    ...
    def get_images(self, index):
        ...
        lowlight = Image.open(self.train_data_dir + 'low/' + lowlight_name).convert('RGB') #'input_unprocess_aligned/' v
        clear = Image.open(self.train_data_dir + 'high/' + gt_name ).convert('RGB')  #'gt_unprocess_aligned/''high/'
