...
class ValData(data.Dataset):
    ...
    def get_images(self, index):
        ...
        if os.path.exists(os.path.join(self.val_data_dir, 'low')):
            lowlight_img = Image.open(os.path.join(self.val_data_dir, 'low', lowlight_name))
            if os.path.exists(os.path.join(self.val_data_dir, 'high')) :
                gt_name = self.gt_names[index]
                gt_img = Image.open(os.path.join(self.val_data_dir, 'high', gt_name)) ##   
                a = lowlight_img.size
